...
% \usepackage{subfig}             %JW: commented out cause using subcaption below!
\usepackage{tikz}
...
% ==== Appendix config =============================================================
\usepackage{appendix}           %use like:
                                %\begin{appendices}
                                %\chapter{simeAppix}
                                %...
                                %\end{appendices}
% \usepackage[toc,page]{appendix} % with title page with toc
% ==================================================================================
...
%% Other ===================================================
\usepackage{url}                % for \path{/my/path} better than \texttt{}
                                % cause does line breaks
\usepackage{dashrule}           % dashed lines

%% Unused ==================================================
% \usepackage{fontawesome}        % Glyphs & icons
% \usepackage{dashrule}           % dashed lines
