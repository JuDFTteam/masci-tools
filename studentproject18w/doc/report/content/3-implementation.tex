...
Calculations can be done with a crystal unit cell (UC) or a super cell  
...
stack. The full survey is documented in \cite{jw-notes}. The requirements on top
of those in the introduction that were as follows: 
...
\cite{pyviz-faq} which was needed in this project for the atoms plot. So it had
to be discarded.
...
where the app can be registered. Details on this procedure and alternative hosting solutions
can be found in the developer Section \vref{sec:developer-manual}. 
