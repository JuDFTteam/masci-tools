...
TEST_MEMBER = [('randomentry5', True, 'RanDomEntry5'), ('snakecaseentry', False, None), ('camelcaseentry', True, 'camelCaseEntry'), ('aBc', True, 'ABC'), ('not_existent', False, None)]
...
TEST_SET = [{'ABC', 'abC', 'RanDomEntry5', 'snake_case_entry', 'camelCaseEntry', 'camelcaseentry'}, {'ABC', 'not_existent', 'snakecaseentry'}]
...
TEST_DIFF_CASES = [{}, {'randomentry5': 'RanDomEntry5', 'camelcaseentry': 'camelCaseEntry', 'snake_case_entry': 'snake_case_entry'}]
...
TEST_UNIONS = [{'camelcaseentry', 'snake_case_entry', 'randomentry5', 'abc'},{'camelcaseentry', 'snake_case_entry', 'randomentry5', 'abc', 'not_existent', 'snakecaseentry'}]
TEST_UNION_CASES = [{'camelcaseentry': 'camelCaseEntry', 'abc': 'ABC', 'randomentry5': 'RanDomEntry5', 'snake_case_entry': 'snake_case_entry'}, {'not_existent': 'not_existent', 'camelcaseentry': 'camelCaseEntry', 'snakecaseentry': 'snakecaseentry', 'snake_case_entry': 'snake_case_entry', 'abc': 'ABC', 'randomentry5': 'RanDomEntry5'}]
...
TEST_SYMDIFF_CASES = [{}, {'snakecaseentry': 'snakecaseentry', 'randomentry5': 'RanDomEntry5', 'camelcaseentry': 'camelCaseEntry', 'not_existent': 'not_existent', 'snake_case_entry': 'snake_case_entry'}]
...
TEST_INTERSECTIONS_CASES = [{'abc': 'ABC', 'randomentry5': 'RanDomEntry5', 'snake_case_entry': 'snake_case_entry', 'camelcaseentry': 'camelCaseEntry'}, {'abc': 'ABC'}]
