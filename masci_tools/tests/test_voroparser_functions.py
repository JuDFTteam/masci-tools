...
class Test_voronoi_parser_functions(object):
    ...
    dref = {
        ...
        'parser_version':
        'some_version_number',
        'emin_minus_efermi_Ry_units':
        'Ry',
        'emin_minus_efermi_Ry':
        -0.90924099999999997,
        'emin':
        -0.5,
        'emin_minus_efermi_units':
        'eV',
        'emin_minus_efermi':
        -12.370853917196168,
        'alat_unit':
        ...
        'radii_atoms_group': [{
            'rout': 0.5590171328,
            'iatom': 1,
            'dist_nn': 0.8660255824,
            'rout_over_dist_nn': 64.55,
            'rmt0_over_rout': 77.46,
            'rmt0': 0.4330127912
        }, {
            'rout': 0.5590171328,
            'iatom': 2,
        ...
        'shapes': [1, 1, 1, 1, 1, 1],
        'code_info_group': {
            'code_version': 'v1.0-6-gf0c2ac3',
            'calculation_serial_number': 'voro_v1.0-6-gf0c2ac3_serial_20171207092915',
            'compile_options': 'serial-O2 -r8 -traceback -i8-mkl -Wl,-stack_size,0x40000000,-stack_addr,0xf0000000'
        },
        'fpradius_atoms_unit':
        'alat',
        'alat':
        5.423514,
        'radial_meshpoints': [484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0],
        'parser_warnings': [],
        'start_from_jellium_potentials':
        True,
        'core_states_group': {
            'energy_highest_lying_core_state_per_atom_unit':
            'Rydberg',
            'energy_highest_lying_core_state_per_atom': [
                None, None, None, None, -3.3287908000000002, -3.3287908000000002, -3.3287908000000002,
                -3.3287908000000002, None, None, None, None
            ],
        ...
        'emin_units':
        'Ry',
        'fpradius_atoms': [0.4696902, 0.4696902, 0.4696902, 0.4696902, 0.4696902, 0.4696902],
        'cluster_info_group': {
            'cluster_info_atoms': [{
                'rmt_ref': 2.3166,
                'refpot': 1,
    ...
    def test_complete_voro_output_filehandle(self):
        ...
        """
        out_dict = {'parser_version': 'some_version_number'}
        success, msg_list, out_dict = parse_voronoi_output(out_dict, open(outfile), open(potfile), open(atominfo),
                                                           open(radii), open(inputfile))
        out_dict['parser_warnings'] = msg_list
        assert success
        assert msg_list == []
        assert out_dict == dref
    ...
    def test_missing_outfile(self):
        ...
        dref2 = {
            ...
            'radial_meshpoints': [484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0],
            'parser_warnings': [
                'Error parsing output of voronoi: Version Info', "Error parsing output of voronoi: 'EMIN'",
                'Error parsing output of voronoi: Cluster Info', 'Error parsing output of voronoi: Jellium startpot',
                'Error parsing output of voronoi: SHAPE Info', 'Error parsing output of voronoi: Volume Info',
                'Error parsing output of voronoi: radii.dat Info',
                'Error parsing output of voronoi: full potential radius'
            ],
            'core_states_group': {
                'energy_highest_lying_core_state_per_atom_unit':
                'Rydberg',
                'energy_highest_lying_core_state_per_atom':
                [None, None, None, None, -3.3287908, -3.3287908, -3.3287908, -3.3287908, None, None, None, None],
                'number_of_core_states_per_atom': [0, 0, 0, 0, 5, 5, 5, 5, 0, 0, 0, 0],
                'descr_highest_lying_core_state_per_atom': [
                    'no core states', 'no core states', 'no core states', 'no core states', '3p', '3p', '3p', '3p',
                    'no core states', 'no core states', 'no core states', 'no core states'
        ...
        assert msg_list == [
            ...
            'Error parsing output of voronoi: Cluster Info', 'Error parsing output of voronoi: Jellium startpot',
            'Error parsing output of voronoi: SHAPE Info', 'Error parsing output of voronoi: Volume Info',
            'Error parsing output of voronoi: radii.dat Info', 'Error parsing output of voronoi: full potential radius'
        ]
    ...
    def test_missing_inputfile(self):
        ...
        dref2 = {
            ...
            'alat',
            'radial_meshpoints': [484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0],
            'parser_warnings': ['Error parsing output of voronoi: alat'],
            'start_from_jellium_potentials':
            True,
            'core_states_group': {
                'energy_highest_lying_core_state_per_atom_unit':
    ...
    def test_missing_potfile(self):
        ...
        dref2 = {
            ...
            5.423514,
            'parser_warnings': [
                "Error parsing output of voronoi: 'EMIN'", 'Error parsing output of voronoi: core_states',
                'Error parsing output of voronoi: radial meshpoints'
            ],
            'start_from_jellium_potentials':
            True,
            'radii_atoms_group': [{
    ...
    def test_missing_radii(self):
        ...
        """
        out_dict = {'parser_version': 'some_version_number'}
        success, msg_list, out_dict = parse_voronoi_output(out_dict, outfile, potfile, atominfo, 'wrong_name',
                                                           inputfile)
        out_dict['parser_warnings'] = msg_list
        dref2 = {
            'volumes_group': {
            ...
            'alat': 5.423514,
            'radial_meshpoints': [484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0, 484.0],
            'parser_warnings': ['Error parsing output of voronoi: radii.dat Info'],
