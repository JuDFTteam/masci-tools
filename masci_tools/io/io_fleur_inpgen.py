...
from masci_tools.util.xml.common_xml_util import convert_to_fortran_bool, convert_to_fortran_string
from masci_tools.io.common_functions import abs_to_rel_f, abs_to_rel
