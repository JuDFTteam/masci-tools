...
class ParseTasks(object):
    ...
    def __init__(version):
        ...
        self.tasks = default_tasks.TASK_DEFINITION.copy()
    ...
    def add_task(self, task_name, task_definition, **kwargs):
        ...
        if task_name in self.tasks and not overwrite:
            raise ValueError(f"Task '{task_name}' is already defined. Use overwrite=True to continue anyway")
    ...
    def __getitem__(self, task):
        ...
        if task in self.tasks:
            ...
            raise KeyError("Unknown Tasks: '{task}'")
