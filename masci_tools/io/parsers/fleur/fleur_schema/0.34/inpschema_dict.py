...
schema_dict = {'attrib_types': {'Gmax': ['float_expression'],
 ...
 'omitt_contained_tags': ['constants',
                          ...
                          'qVectors'],
 'other_attribs': {'J': ['/fleurInput/atomSpecies/species/ldaU',
                   ...
                   'M': ['/fleurInput/atomSpecies/species/nocoParams',
                         '/fleurInput/atomGroups/atomGroup/nocoParams'],
                   'TwoD': ['/fleurInput/output/plotting/plot'],
                   'U': ['/fleurInput/atomSpecies/species/ldaU',
                         '/fleurInput/atomGroups/atomGroup/ldaU',
                         '/fleurInput/atomSpecies/species/ldaHIA',
                         '/fleurInput/atomGroups/atomGroup/ldaHIA'],
                   'absPos': ['/fleurInput/atomGroups/atomGroup/absPos'],
                   'alpha': ['/fleurInput/atomGroups/atomGroup/relPos',
                   ...
                   'b_cons_x': ['/fleurInput/atomSpecies/species/nocoParams',
                                '/fleurInput/atomGroups/atomGroup/nocoParams'],
                   'b_cons_y': ['/fleurInput/atomSpecies/species/nocoParams',
                                '/fleurInput/atomGroups/atomGroup/nocoParams'],
                   'b_field_mt': ['/fleurInput/atomSpecies/species/special'],
                   'banddos': ['/fleurInput/atomGroups/atomGroup/relPos',
                               '/fleurInput/atomGroups/atomGroup/absPos',
                               '/fleurInput/atomGroups/atomGroup/filmPos'],
                   'beta': ['/fleurInput/atomGroups/atomGroup/relPos',
                            '/fleurInput/atomGroups/atomGroup/absPos',
                            '/fleurInput/atomGroups/atomGroup/filmPos',
                            '/fleurInput/atomSpecies/species/nocoParams',
                            '/fleurInput/atomGroups/atomGroup/nocoParams'],
                   'calculate': ['/fleurInput/atomSpecies/species/force',
                   ...
                   'flipSpinPhi': ['/fleurInput/atomSpecies/species/modInitDen',
                                   '/fleurInput/atomGroups/atomGroup/modInitDen'],
                   'flipSpinScale': ['/fleurInput/atomSpecies/species/modInitDen',
                                     '/fleurInput/atomGroups/atomGroup/modInitDen'],
                   'flipSpinTheta': ['/fleurInput/atomSpecies/species/modInitDen',
                                     '/fleurInput/atomGroups/atomGroup/modInitDen'],
                   'gamma': ['/fleurInput/atomGroups/atomGroup/relPos',
                             '/fleurInput/atomGroups/atomGroup/absPos',
                             '/fleurInput/atomGroups/atomGroup/filmPos'],
                   ...
                   'init_mom': ['/fleurInput/atomSpecies/species/ldaHIA/exc',
                                '/fleurInput/atomGroups/atomGroup/ldaHIA/exc'],
                   'init_occ': ['/fleurInput/atomSpecies/species/ldaHIA',
                                '/fleurInput/atomGroups/atomGroup/ldaHIA'],
                   'kPoint': ['/fleurInput/cell/bzIntegration/kPointLists/kPointList/kPoint'],
                   'key': ['/fleurInput/atomSpecies/species/ldaHIA/addArg',
                           '/fleurInput/atomGroups/atomGroup/ldaHIA/addArg'],
                   'kkintgrCutoff': ['/fleurInput/atomSpecies/species/ldaHIA',
                                     '/fleurInput/atomGroups/atomGroup/ldaHIA',
                   ...
                   'l': ['/fleurInput/atomSpecies/species/ldaU',
                         '/fleurInput/atomGroups/atomGroup/ldaU',
                         '/fleurInput/atomSpecies/species/ldaHIA',
                         '/fleurInput/atomGroups/atomGroup/ldaHIA',
                         '/fleurInput/atomSpecies/species/ldaHIA/exc',
                         ...
                         '/fleurInput/atomGroups/atomGroup/lo'],
                   'l_amf': ['/fleurInput/atomSpecies/species/ldaU',
                             '/fleurInput/atomGroups/atomGroup/ldaU',
                             '/fleurInput/atomSpecies/species/ldaHIA',
                             '/fleurInput/atomGroups/atomGroup/ldaHIA'],
                   'l_constrained': ['/fleurInput/atomSpecies/species/nocoParams',
                                     '/fleurInput/atomGroups/atomGroup/nocoParams'],
                   'l_fermi': ['/fleurInput/calculationSetup/greensFunction/contourDOS'],
                   'l_magn': ['/fleurInput/atomSpecies/species/nocoParams',
                              '/fleurInput/atomGroups/atomGroup/nocoParams'],
                   'l_mtNocoPot': ['/fleurInput/atomSpecies/species/nocoParams',
                                   '/fleurInput/atomGroups/atomGroup/nocoParams'],
                   'l_relaxSQA': ['/fleurInput/atomSpecies/species/nocoParams',
                                  '/fleurInput/atomGroups/atomGroup/nocoParams'],
                   'l_sphavg': ['/fleurInput/atomSpecies/species/greensfCalculation',
                                '/fleurInput/atomGroups/atomGroup/greensfCalculation'],
                   'label': ['/fleurInput/atomGroups/atomGroup/relPos',
                             '/fleurInput/atomGroups/atomGroup/absPos',
                             '/fleurInput/atomGroups/atomGroup/filmPos',
                             '/fleurInput/atomSpecies/species/ldaHIA',
                             '/fleurInput/atomGroups/atomGroup/ldaHIA',
                   ...
                   'lmaxAPW': ['/fleurInput/atomSpecies/species/atomicCutoffs',
                               '/fleurInput/atomGroups/atomGroup/atomicCutoffs'],
                   'lnonsphr': ['/fleurInput/atomSpecies/species/atomicCutoffs',
                                '/fleurInput/atomGroups/atomGroup/atomicCutoffs'],
                   'logIncrement': ['/fleurInput/atomSpecies/species/mtSphere',
                                    '/fleurInput/atomGroups/atomGroup/mtSphere'],
                   'm': ['/fleurInput/atomSpecies/species/ldaHIA/cFCoeff',
                         '/fleurInput/atomGroups/atomGroup/ldaHIA/cFCoeff'],
                   'magField': ['/fleurInput/atomGroups/atomGroup'],
                   'magMom': ['/fleurInput/atomSpecies/species/modInitDen',
                              '/fleurInput/atomGroups/atomGroup/modInitDen'],
                   ...
                   'name': ['/fleurInput/constants/constant',
                   ...
                   'nshells': ['/fleurInput/atomSpecies/species/greensfCalculation',
                               '/fleurInput/atomGroups/atomGroup/greensfCalculation'],
                   ...
                   'phi': ['/fleurInput/atomSpecies/species/ldaU',
                           '/fleurInput/atomGroups/atomGroup/ldaU',
                           '/fleurInput/atomSpecies/species/ldaHIA',
                           '/fleurInput/atomGroups/atomGroup/ldaHIA'],
                   ...
                   'relaxXYZ': ['/fleurInput/atomSpecies/species/force',
                                '/fleurInput/atomGroups/atomGroup/force'],
                   ...
                   'spinDown': ['/fleurInput/cell/filmLattice/vacuumEnergyParameters',
                                '/fleurInput/atomSpecies/species/electronConfig/stateOccupation'],
                   'spinUp': ['/fleurInput/cell/filmLattice/vacuumEnergyParameters',
                              '/fleurInput/atomSpecies/species/electronConfig/stateOccupation'],
                   'state': ['/fleurInput/atomSpecies/species/electronConfig/stateOccupation'],
                   'theta': ['/fleurInput/atomSpecies/species/ldaU',
                             '/fleurInput/atomGroups/atomGroup/ldaU',
                             '/fleurInput/atomSpecies/species/ldaHIA',
                             '/fleurInput/atomGroups/atomGroup/ldaHIA'],
                   ...
                   'wannier': ['/fleurInput/atomGroups/atomGroup/relPos',
                               '/fleurInput/atomGroups/atomGroup/absPos',
                               '/fleurInput/atomGroups/atomGroup/filmPos'],
 ...
 'tag_info': {'/fleurInput': {'attribs': ['fleurInputVersion'],
              ...
              '/fleurInput/atomGroups/atomGroup/greensfCalculation/diagElements': {'attribs': ['s',
                                                                                   ...
                                                                                   'simple': [],
                                                                                   'text': []},
              '/fleurInput/atomGroups/atomGroup/greensfCalculation/matrixElements': {'attribs': [],
                                                                                     'optional': [],
                                                                                     'optional_attribs': [],
                                                                                     'order': ['s',
                                                                                               'p',
              ...
              '/fleurInput/atomGroups/atomGroup/ldaHIA/addArg': {'attribs': ['key',
                                                                 ...
                                                                 'simple': [],
                                                                 'text': []},
              '/fleurInput/atomGroups/atomGroup/ldaHIA/cFCoeff': {'attribs': ['l',
                                                                              'm',
                                                                              'value'],
                                                                  'optional': [],
                                                                  'optional_attribs': [],
              ...
              '/fleurInput/atomGroups/atomGroup/lo': {'attribs': ['type',
                                                      ...
                                                      'simple': [],
                                                      'text': []},
              '/fleurInput/atomGroups/atomGroup/modInitDen': {'attribs': ['magMom',
                                                                          'flipSpinPhi',
                                                                          'flipSpinTheta',
                                                                          'flipSpinScale'],
                                                              'optional': [],
                                                              'optional_attribs': ['magMom',
                                                                                   'flipSpinPhi',
                                                                                   'flipSpinTheta',
                                                                                   'flipSpinScale'],
                                                              'order': [],
              ...
              '/fleurInput/atomGroups/atomGroup/mtSphere': {'attribs': ['radius',
                                                            ...
                                                            'simple': [],
                                                            'text': []},
              '/fleurInput/atomGroups/atomGroup/nocoParams': {'attribs': ['l_constrained',
                                                                          'l_mtNocoPot',
                                                                          'l_relaxSQA',
                                                                          'l_magn',
                                                                          'M',
                                                                          ...
                                                                          'b_cons_y'],
                                                              'optional': [],
                                                              'optional_attribs': ['l_constrained',
                                                                                   'l_mtNocoPot',
                                                                                   'l_relaxSQA',
                                                                                   'l_magn',
                                                                                   'M',
              ...
              '/fleurInput/atomGroups/atomGroup/torgueCalculation': {'attribs': ['kkintgrCutoff',
                                                                                 'label'],
                                                                     'optional': [],
                                                                     'optional_attribs': ['kkintgrCutoff',
                                                                                          'label'],
                                                                     'order': ['greensfElements'],
                                                                     'several': [],
                                                                     'simple': [],
                                                                     'text': []},
              '/fleurInput/atomGroups/atomGroup/torgueCalculation/greensfElements': {'attribs': [],
                                                                                     'optional': [],
                                                                                     'optional_attribs': [],
                                                                                     'order': ['s',
                                                                                               'p',
                                                                                     ...
                                                                                     'text': ['s',
                                                                                              ...
                                                                                              'd',
                                                                                              'f']},
              '/fleurInput/atomSpecies': {'attribs': [],
                                          'optional': [],
                                          'optional_attribs': [],
                                          'order': ['species'],
                                          'several': ['species'],
              ...
              '/fleurInput/atomSpecies/species/atomicCutoffs': {'attribs': ['lmax',
                                                                ...
                                                                'simple': [],
                                                                'text': []},
              '/fleurInput/atomSpecies/species/electronConfig': {'attribs': [],
                                                                 'optional': ['valenceConfig',
                                                                              'stateOccupation'],
                                                                 'optional_attribs': [],
                                                                 'order': ['coreConfig',
                                                                           'valenceConfig',
              ...
              '/fleurInput/atomSpecies/species/greensfCalculation/diagElements': {'attribs': ['s',
                                                                                  ...
                                                                                  'simple': [],
                                                                                  'text': []},
              '/fleurInput/atomSpecies/species/greensfCalculation/matrixElements': {'attribs': [],
                                                                                    'optional': [],
                                                                                    'optional_attribs': [],
                                                                                    'order': ['s',
                                                                                              'p',
              ...
              '/fleurInput/atomSpecies/species/ldaHIA/addArg': {'attribs': ['key',
                                                                ...
                                                                'simple': [],
                                                                'text': []},
              '/fleurInput/atomSpecies/species/ldaHIA/cFCoeff': {'attribs': ['l',
                                                                             'm',
                                                                             'value'],
                                                                 'optional': [],
                                                                 'optional_attribs': [],
              ...
              '/fleurInput/atomSpecies/species/lo': {'attribs': ['type',
                                                     ...
                                                     'simple': [],
                                                     'text': []},
              '/fleurInput/atomSpecies/species/modInitDen': {'attribs': ['magMom',
                                                                         'flipSpinPhi',
                                                                         'flipSpinTheta',
                                                                         'flipSpinScale'],
                                                             'optional': [],
              ...
              '/fleurInput/atomSpecies/species/mtSphere': {'attribs': ['radius',
                                                           ...
                                                           'simple': [],
                                                           'text': []},
              '/fleurInput/atomSpecies/species/nocoParams': {'attribs': ['l_constrained',
                                                                         'l_mtNocoPot',
                                                                         'l_relaxSQA',
                                                                         'l_magn',
                                                                         'M',
              ...
              '/fleurInput/atomSpecies/species/torgueCalculation': {'attribs': ['kkintgrCutoff',
                                                                    ...
                                                                    'simple': [],
                                                                    'text': []},
              '/fleurInput/atomSpecies/species/torgueCalculation/greensfElements': {'attribs': [],
                                                                                    'optional': [],
                                                                                    'optional_attribs': [],
                                                                                    'order': ['s',
                                                                                              'p',
                                                                                    ...
                                                                                    'text': ['s',
                                                                                             ...
                                                                                             'd',
                                                                                             'f']},
              '/fleurInput/calculationSetup': {'attribs': [],
                                               'optional': ['prodBasis',
                                                            'soc',
                                                            'oneDParams',
                                                            'expertModes',
              ...
              '/fleurInput/calculationSetup/greensFunction/realAxis': {'attribs': ['ne',
                                                                       ...
                                                                       'simple': [],
                                                                       'text': []},
              '/fleurInput/calculationSetup/ldaHIA': {'attribs': ['itmaxHubbard1',
                                                                  'beta',
                                                                  'minoccDistance',
                                                                  'minmatDistance',
                                                                  'n_occpm',
              ...
              '/fleurInput/calculationSetup/magnetism': {'attribs': ['jspins',
                                                         ...
                                                         'text': ['qss',
                                                                  'qsc']},
              '/fleurInput/calculationSetup/magnetism/mtNocoParams': {'attribs': ['l_mtNocoPot',
                                                                                  'l_mperp',
                                                                                  'l_constrained',
                                                                                  'l_relaxSQA',
                                                                                  'mag_mixing_scheme',
                                                                      ...
                                                                      'simple': [],
                                                                      'text': []},
              '/fleurInput/calculationSetup/magnetism/sourceFreeMag': {'attribs': ['l_sourceFree',
                                                                                   'l_scaleMag',
                                                                                   'mag_scale'],
                                                                       'optional': [],
                                                                       'optional_attribs': ['l_sourceFree',
                                                                                            'l_scaleMag',
                                                                                            'mag_scale'],
                                                                       'order': [],
                                                                       'several': [],
              ...
              '/fleurInput/calculationSetup/spinSpiralQPointMesh': {'attribs': ['qx',
                                                                    ...
                                                                    'simple': [],
                                                                    'text': []},
              '/fleurInput/calculationSetup/xcFunctional': {'attribs': ['name',
                                                            ...
                                                            'simple': ['LibXCID',
                                                                       ...
                                                                       'ggaPrinting'],
                                                            'text': []},
              '/fleurInput/calculationSetup/xcFunctional/LibXCID': {'attribs': ['exchange',
                                                                                'correlation',
                                                                                'etot_exchange',
                                                                                'etot_correlation'],
                                                                    'optional': [],
                                                                    'optional_attribs': ['etot_exchange',
                                                                                         'etot_correlation'],
                                                                    'order': [],
                                                                    'several': [],
                                                                    'simple': [],
                                                                    'text': []},
              '/fleurInput/calculationSetup/xcFunctional/LibXCName': {'attribs': ['exchange',
                                                                                  'correlation',
                                                                                  'etot_exchange',
                                                                                  'etot_correlation'],
                                                                      'optional': [],
                                                                      ...
                                                                      'simple': [],
                                                                      'text': []},
              '/fleurInput/calculationSetup/xcFunctional/ggaPrinting': {'attribs': ['iggachk',
                                                                                    'idsprs0',
                                                                                    'idsprsl',
                                                                                    'idsprsi',
                                                                                    'idsprsv'],
                                                                        ...
                                                                        'simple': [],
                                                                        'text': []},
              '/fleurInput/calculationSetup/xcFunctional/xcParams': {'attribs': ['igrd',
                                                                                 'lwb',
                                                                                 'ndvgrd',
                                                                                 'idsprs',
                                                                                 'chng'],
              ...
              '/fleurInput/cell/bulkLattice/a2': {'attribs': ['scale'],
                                                  ...
                                                  'simple': [],
                                                  'text': []},
              '/fleurInput/cell/bulkLattice/bravaisMatrix': {'attribs': [],
                                                             'optional': [],
                                                             'optional_attribs': [],
                                                             'order': ['row-1',
                                                                       'row-2',
              ...
              '/fleurInput/cell/bulkLattice/c': {'attribs': ['scale'],
                                                 ...
                                                 'simple': [],
                                                 'text': []},
              '/fleurInput/cell/bzIntegration': {'attribs': ['valenceElectrons',
                                                             'mode',
                                                             'fermiSmearingEnergy',
                                                             'fermiSmearingTemp',
                                                             'l_bloechl'],
                                                 'optional': [],
                                                 'optional_attribs': ['valenceElectrons',
                                                                      'mode',
                                                                      'fermiSmearingEnergy',
                                                                      'fermiSmearingTemp',
                                                                      'l_bloechl'],
                                                 ...
                                                 'text': []},
              '/fleurInput/cell/bzIntegration/kPointListSelection': {'attribs': ['listName'],
                                                                     'optional': [],
                                                                     'optional_attribs': [],
                                                                     'order': [],
                                                                     'several': [],
                                                                     'simple': [],
                                                                     'text': []},
              '/fleurInput/cell/bzIntegration/kPointLists': {'attribs': [],
                                                             'optional': [],
                                                             'optional_attribs': [],
                                                             'order': ['kPointList'],
                                                             'several': ['kPointList'],
                                                             'simple': [],
                                                             'text': []},
              '/fleurInput/cell/bzIntegration/kPointLists/kPointList': {'attribs': ['name',
                                                                                    'type',
                                                                                    'count',
                                                                                    'nx',
                                                                                    'ny',
                                                                        ...
                                                                        'simple': ['kPoint'],
                                                                        'text': ['kPoint']},
              '/fleurInput/cell/bzIntegration/kPointLists/kPointList/kPoint': {'attribs': ['weight',
                                                                                           'label'],
                                                                               'optional': [],
                                                                               'optional_attribs': ['label'],
                                                                               'order': [],
              ...
              '/fleurInput/cell/filmLattice/a2': {'attribs': ['scale'],
                                                  ...
                                                  'simple': [],
                                                  'text': []},
              '/fleurInput/cell/filmLattice/bravaisMatrix': {'attribs': [],
                                                             'optional': [],
                                                             'optional_attribs': [],
                                                             'order': ['row-1',
                                                                       'row-2',
              ...
              '/fleurInput/cell/filmLattice/vacuumEnergyParameters': {'attribs': ['vacuum',
                                                                      ...
                                                                      'simple': [],
                                                                      'text': []},
              '/fleurInput/cell/symmetryOperations': {'attribs': [],
                                                      'optional': [],
                                                      'optional_attribs': [],
                                                      'order': ['symOp'],
                                                      'several': ['symOp'],
                                                      'simple': [],
                                                      'text': []},
              '/fleurInput/cell/symmetryOperations/symOp': {'attribs': [],
                                                            'optional': [],
                                                            'optional_attribs': [],
                                                            'order': ['row-1',
                                                                      'row-2',
              ...
              '/fleurInput/constants/constant': {'attribs': ['name', 'value'],
                                                 ...
                                                 'simple': [],
                                                 'text': []},
              '/fleurInput/forceTheorem': {'attribs': [],
                                           'optional': [],
                                           'optional_attribs': [],
                                           'order': ['MAE',
                                                     'spinSpiralDispersion',
              ...
              '/fleurInput/forceTheorem/DMI': {'attribs': ['theta', 'phi'],
                                               ...
                                               'simple': [],
                                               'text': []},
              '/fleurInput/forceTheorem/DMI/qVectors': {'attribs': [],
                                                        'optional': [],
                                                        'optional_attribs': [],
                                                        'order': ['q'],
                                                        'several': ['q'],
              ...
              '/fleurInput/forceTheorem/Jij': {'attribs': ['thetaj'],
                                               ...
                                               'simple': [],
                                               'text': []},
              '/fleurInput/forceTheorem/Jij/qVectors': {'attribs': [],
                                                        'optional': [],
                                                        'optional_attribs': [],
                                                        'order': ['q'],
                                                        'several': ['q'],
              ...
              '/fleurInput/forceTheorem/MAE': {'attribs': ['theta', 'phi'],
                                               ...
                                               'simple': [],
                                               'text': []},
              '/fleurInput/forceTheorem/spinSpiralDispersion': {'attribs': [],
                                                                'optional': [],
                                                                'optional_attribs': [],
                                                                'order': ['q'],
                                                                'several': ['q'],
              ...
              '/fleurInput/output/coreSpectrum': {'attribs': ['eKin',
                                                  ...
                                                  'simple': ['edgeIndices'],
                                                  'text': ['edgeIndices']},
              '/fleurInput/output/juPhon': {'attribs': ['l_potout', 'l_eigout'],
                                            'optional': [],
                                            'optional_attribs': [],
                                            'order': [],
                                            'several': [],
              ...
              '/fleurInput/output/wannier/bandSelection': {'attribs': ['minSpinUp',
                                                                       ...
                                                                       'maxSpinDown'],
                                                           'optional': [],
                                                           'optional_attribs': ['minSpinDown',
                                                                                'maxSpinDown'],
                                                           'order': [],
                                                           'several': [],
                                                           'simple': [],
                                                           'text': []},
              '/fleurInput/relaxation': {'attribs': [],
                                         ...
                                         'simple': [],
                                         'text': []},
              '/fleurInput/relaxation/displacements': {'attribs': [],
                                                       'optional': [],
                                                       'optional_attribs': [],
                                                       'order': ['displace'],
                                                       'several': ['displace'],
                                                       'simple': ['displace'],
                                                       'text': ['displace']},
              '/fleurInput/relaxation/relaxation-history': {'attribs': [],
                                                            'optional': [],
                                                            'optional_attribs': [],
                                                            'order': ['step'],
                                                            'several': ['step'],
 ...
 'unique_attribs': {'Gmax': '/fleurInput/calculationSetup/cutoffs',
 ...
 'unique_path_attribs': {'a1': ['/fleurInput/cell/bulkLattice/a1',
                                '/fleurInput/cell/filmLattice/a1'],
                         'a2': ['/fleurInput/cell/bulkLattice/a2',
                                '/fleurInput/cell/filmLattice/a2'],
