...
schema_dict = {'attrib_types': {'Angles': ['int'],
                  'Configs': ['int'],
                  'Delta': ['float'],
                  'F_x': ['float'],
                  'F_y': ['float'],
 ...
 'basic_types': {'AdditionalCompilerFlagsType': {'base_types': ['string'],
                 ...
                 'ForceTheoremEnum': {'base_types': ['string'], 'length': 1},
 ...
 'iteration_other_attribs': {'Delta': ['./onSiteExchangeSplitting/excSplit'],
                             ...
                             'atomType': ['./Forcetheorem_DMI/allAtoms',
                                          './Forcetheorem_DMI/singleAtom',
                             ...
                             'branch': ['./energyParameters/atomicEP',
                                        './energyParameters/heAtomicEP',
                                        './energyParameters/loAtomicEP',
                                        './energyParameters/heloAtomicEP'],
                             'branchHighest': ['./energyParameters/atomicEP',
                                               './energyParameters/heAtomicEP',
                                               './energyParameters/loAtomicEP',
                                               './energyParameters/heloAtomicEP'],
                             'branchLowest': ['./energyParameters/atomicEP',
                                              './energyParameters/heAtomicEP',
                                              './energyParameters/loAtomicEP',
                                              './energyParameters/heloAtomicEP'],
                             'calculationType': ['./Forcetheorem_Loop'],
                             'comment': ['./totalEnergy'],
                             'd': ['./valenceDensity/mtCharges/mtCharge',
                                   './allElectronCharges/mtCharges/mtCharge',
                             ...
                             'ev-sum': ['./Forcetheorem_SSDISP/Entry',
                                        './Forcetheorem_MAE/Angle',
                                        './Forcetheorem_JIJ/Config',
                                        './Forcetheorem_DMI/Entry'],
                             'f': ['./valenceDensity/mtCharges/mtCharge',
                                   './allElectronCharges/mtCharges/mtCharge',
                                   './valenceDensity/mtCharges/mtJcharge/lowJ',
                                   './allElectronCharges/mtCharges/mtJcharge/lowJ',
                                   './valenceDensity/mtCharges/mtJcharge/highJ',
                             ...
                             'interstitial': ['./valenceDensity/spinDependentCharge',
                             ...
                             'moment': ['./magneticMomentsInMTSpheres/magneticMoment',
                                        './orbitalMagneticMomentsInMTSpheres/orbMagMoment'],
                             'mtSpheres': ['./valenceDensity/spinDependentCharge',
                                           './allElectronCharges/spinDependentCharge',
                                           './valenceDensity/fixedCharges/spinDependentCharge',
                                           './allElectronCharges/fixedCharges/spinDependentCharge'],
                             'n': ['./Forcetheorem_JIJ/Config',
                                   './coreStates/state'],
                             'name': ['./timing/timer'],
                             'occupation': ['./rdmft/occupations/state'],
                             'p': ['./valenceDensity/mtCharges/mtCharge',
                                   './allElectronCharges/mtCharges/mtCharge',
                                   './valenceDensity/mtCharges/mtJcharge/lowJ',
                                   './allElectronCharges/mtCharges/mtJcharge/lowJ',
                                   './valenceDensity/mtCharges/mtJcharge/highJ',
                             ...
                             'phi': ['./Forcetheorem_MAE/Angle',
                                     './Forcetheorem_DMI/Entry',
                                     './Forcetheorem_DMI/allAtoms',
                                     './Forcetheorem_DMI/singleAtom'],
                             'q': ['./Forcetheorem_SSDISP/Entry',
                                   './Forcetheorem_JIJ/Config',
                                   './Forcetheorem_DMI/Entry',
                                   './Forcetheorem_DMI/allAtoms',
                                   './Forcetheorem_DMI/singleAtom'],
                             's': ['./valenceDensity/mtCharges/mtCharge',
                                   './allElectronCharges/mtCharges/mtCharge'],
                             'sigma_x': ['./noncollinearTorgue/torgue',
                                         './spinorbitTorgue/torgue'],
                             'sigma_y': ['./noncollinearTorgue/torgue',
                                         './spinorbitTorgue/torgue'],
                             'sigma_z': ['./noncollinearTorgue/torgue',
                                         './spinorbitTorgue/torgue'],
                             'spin': ['./energyParameters/atomicEP',
                                      './energyParameters/heAtomicEP',
                                      './energyParameters/loAtomicEP',
                                      './energyParameters/heloAtomicEP',
                                      ...
                                      './densityConvergence/overallChargeDensity',
                                      './densityConvergence/spinDensity'],
                             'spinDownCharge': ['./magneticMomentsInMTSpheres/magneticMoment',
                                                './orbitalMagneticMomentsInMTSpheres/orbMagMoment'],
                             'spinUpCharge': ['./magneticMomentsInMTSpheres/magneticMoment',
                                              './orbitalMagneticMomentsInMTSpheres/orbMagMoment'],
                             'theta': ['./Forcetheorem_MAE/Angle',
                                       './Forcetheorem_DMI/Entry',
                                       './Forcetheorem_DMI/allAtoms',
                                       './Forcetheorem_DMI/singleAtom'],
                             'total': ['./valenceDensity/mtCharges/mtCharge',
                                       './allElectronCharges/mtCharges/mtCharge',
                                       './valenceDensity/spinDependentCharge',
                                       './allElectronCharges/spinDependentCharge',
                                       './valenceDensity/fixedCharges/spinDependentCharge',
                             ...
                             'vacuum1': ['./valenceDensity/spinDependentCharge',
                                         './allElectronCharges/spinDependentCharge',
                                         './valenceDensity/fixedCharges/spinDependentCharge',
                                         './allElectronCharges/fixedCharges/spinDependentCharge'],
                             'vacuum2': ['./valenceDensity/spinDependentCharge',
                                         './allElectronCharges/spinDependentCharge',
                                         './valenceDensity/fixedCharges/spinDependentCharge',
                                         './allElectronCharges/fixedCharges/spinDependentCharge'],
                             'value': ['./energyParameters/atomicEP',
                                       './energyParameters/heAtomicEP',
                                       './energyParameters/loAtomicEP',
                                       './energyParameters/heloAtomicEP',
                                       './energyParameters/vacuumEP',
 ...
 'iteration_tag_info': {'./FermiEnergy': {'attribs': ['value', 'units'],
                                          'optional': [],
                                          ...
                                          'simple': [],
                                          'text': []},
                        './Forcetheorem_DMI': {'attribs': ['Angles',
                                                           'qpoints',
                                                           'units'],
                                               'optional': ['Entry',
                                                            'allAtoms',
                                               ...
                                               'simple': ['Entry',
                                                          ...
                                                          'singleAtom'],
                                               'text': []},
                        './Forcetheorem_DMI/Entry': {'attribs': ['q',
                                                                 'phi',
                                                                 'theta',
                                                                 'ev-sum'],
                                                     'optional': [],
                                                     ...
                                                     'simple': [],
                                                     'text': []},
                        './Forcetheorem_DMI/allAtoms': {'attribs': ['atomType',
                                                                    'q',
                                                                    'phi',
                                                                    'theta',
                                                                    'H_so'],
                                                        ...
                                                        'simple': [],
                                                        'text': []},
                        './Forcetheorem_DMI/singleAtom': {'attribs': ['atomType',
                                                                      'q',
                                                                      'phi',
                                                                      'theta',
                                                                      'H_so'],
                                                          ...
                                                          'simple': [],
                                                          'text': []},
                        './Forcetheorem_JIJ': {'attribs': ['Configs', 'units'],
                                               'optional': ['Config'],
                                               'optional_attribs': [],
                                               'order': ['Config'],
                                               'several': ['Config'],
                                               'simple': ['Config'],
                                               'text': []},
                        './Forcetheorem_JIJ/Config': {'attribs': ['n',
                                                                  'q',
                                                                  'iatom',
                                                                  'jatom',
                                                                  'phase',
                                                      ...
                                                      'simple': [],
                                                      'text': []},
                        './Forcetheorem_Loop': {'attribs': ['No',
                                                            'calculationType'],
                                                'optional': [],
                                                'optional_attribs': [],
                                                'order': ['energyParameters',
                                                          'eigenvalues',
                                                          'bandgap',
                                                          'sumValenceSingleParticleEnergies',
                                                          'FermiEnergy',
                                                ...
                                                'simple': [],
                                                'text': []},
                        './Forcetheorem_MAE': {'attribs': ['Angles', 'units'],
                                               'optional': ['Angle'],
                                               'optional_attribs': [],
                                               'order': ['Angle'],
                                               'several': ['Angle'],
                                               'simple': ['Angle'],
                                               'text': []},
                        './Forcetheorem_MAE/Angle': {'attribs': ['phi',
                                                                 'theta',
                                                                 'ev-sum'],
                                                     'optional': [],
                                                     'optional_attribs': [],
                                                     ...
                                                     'simple': [],
                                                     'text': []},
                        './Forcetheorem_SSDISP': {'attribs': ['qvectors',
                                                              'units'],
                                                  'optional': ['Entry'],
                                                  'optional_attribs': [],
                                                  'order': ['Entry'],
                                                  ...
                                                  'simple': ['Entry'],
                                                  'text': []},
                        './Forcetheorem_SSDISP/Entry': {'attribs': ['q',
                                                                    'ev-sum'],
                                                        'optional': [],
                                                        'optional_attribs': [],
                                                        'order': [],
                        ...
                        './allElectronCharges': {'attribs': [],
                                                 ...
                                                 'several': ['mtCharges',
                                                             ...
                                                             'totalCharge',
                                                             'fixedCharges'],
                                                 'simple': ['spinDependentCharge',
                                                            'totalCharge'],
                                                 'text': []},
                        './allElectronCharges/fixedCharges': {'attribs': [],
                                                              'optional': ['spinDependentCharge',
                                                                           'totalCharge'],
                                                              'optional_attribs': [],
                                                              'order': ['spinDependentCharge',
                                                                        'totalCharge'],
                                                              'several': ['spinDependentCharge',
                                                                          'totalCharge'],
                                                              'simple': ['spinDependentCharge',
                                                                         'totalCharge'],
                                                              'text': []},
                        './allElectronCharges/fixedCharges/spinDependentCharge': {'attribs': ['spin',
                                                                                              'total',
                                                                                              'interstitial',
                                                                                              'mtSpheres',
                                                                                              'vacuum1',
                                                                                  ...
                                                                                  'simple': [],
                                                                                  'text': []},
                        './allElectronCharges/fixedCharges/totalCharge': {'attribs': ['value',
                                                                                      'units'],
                                                                          'optional': [],
                                                                          'optional_attribs': ['units'],
                                                                          'order': [],
                                                                          ...
                                                                          'simple': [],
                                                                          'text': []},
                        './allElectronCharges/mtCharges': {'attribs': ['spin'],
                                                           'optional': ['mtCharge',
                                                                        'mtJcharge'],
                                                           'optional_attribs': ['spin'],
                                                           'order': ['mtCharge',
                                                           ...
                                                           'simple': ['mtCharge'],
                                                           'text': []},
                        './allElectronCharges/mtCharges/mtCharge': {'attribs': ['atomType',
                                                                                'total',
                                                                                's',
                                                                                'p',
                                                                                'd',
                                                                    ...
                                                                    'simple': [],
                                                                    'text': []},
                        './allElectronCharges/mtCharges/mtJcharge': {'attribs': ['atomType'],
                                                                     'optional': [],
                                                                     'optional_attribs': [],
                                                                     'order': ['lowJ',
                                                                               'highJ'],
                                                                     ...
                                                                     'simple': ['lowJ',
                                                                                'highJ'],
                                                                     'text': []},
                        './allElectronCharges/mtCharges/mtJcharge/highJ': {'attribs': ['p',
                                                                                       'd',
                                                                                       'f'],
                                                                           'optional': [],
                                                                           'optional_attribs': [],
                                                                           ...
                                                                           'simple': [],
                                                                           'text': []},
                        './allElectronCharges/mtCharges/mtJcharge/lowJ': {'attribs': ['p',
                                                                                      'd',
                                                                                      'f'],
                                                                          'optional': [],
                                                                          'optional_attribs': [],
                                                                          ...
                                                                          'simple': [],
                                                                          'text': []},
                        './allElectronCharges/spinDependentCharge': {'attribs': ['spin',
                                                                                 'total',
                                                                                 'interstitial',
                                                                                 'mtSpheres',
                                                                                 'vacuum1',
                                                                     ...
                                                                     'simple': [],
                                                                     'text': []},
                        './allElectronCharges/totalCharge': {'attribs': ['value',
                                                                         'units'],
                                                             'optional': [],
                                                             'optional_attribs': ['units'],
                                                             'order': [],
                        ...
                        './coreStates/state': {'attribs': ['n',
                                               ...
                                               'simple': [],
                                               'text': []},
                        './densityConvergence': {'attribs': ['units'],
                                                 'optional': ['chargeDensity',
                                                 ...
                                                 'order': ['chargeDensity',
                                                           'overallChargeDensity',
                                                           'spinDensity'],
                                                 'several': ['chargeDensity',
                                                             'overallChargeDensity',
                                                             'spinDensity'],
                                                 'simple': ['chargeDensity',
                                                            'overallChargeDensity',
                                                            'spinDensity'],
                                                 'text': []},
                        './densityConvergence/chargeDensity': {'attribs': ['spin',
                                                                           'distance',
                                                                           'units'],
                                                               'optional': [],
                                                               'optional_attribs': ['spin',
                                                               ...
                                                               'simple': [],
                                                               'text': []},
                        './densityConvergence/overallChargeDensity': {'attribs': ['spin',
                                                                                  'distance',
                                                                                  'units'],
                                                                      'optional': [],
                                                                      'optional_attribs': ['spin',
                                                                      ...
                                                                      'simple': [],
                                                                      'text': []},
                        './densityConvergence/spinDensity': {'attribs': ['spin',
                                                                         'distance',
                                                                         'units'],
                                                             'optional': [],
                                                             'optional_attribs': ['spin',
                        ...
                        './eigenvalues': {'attribs': [],
                                          ...
                                          'text': ['eigenvaluesAt']},
                        './eigenvalues/eigenvaluesAt': {'attribs': ['spin',
                                                                    'ikpt',
                                                                    'k_x',
                                                                    'k_y',
                                                                    'k_z'],
                                                        ...
                                                        'simple': [],
                                                        'text': []},
                        './energyParameters': {'attribs': ['units'],
                                               'optional': ['atomicEP',
                                                            'heAtomicEP',
                                                            'loAtomicEP',
                                                            'heloAtomicEP',
                                               ...
                                               'simple': ['atomicEP',
                                                          ...
                                                          'vacuumEP'],
                                               'text': []},
                        './energyParameters/atomicEP': {'attribs': ['atomType',
                                                                    'spin',
                                                                    'branch',
                                                                    'branchLowest',
                                                                    'branchHighest',
                                                        ...
                                                        'simple': [],
                                                        'text': []},
                        './energyParameters/heAtomicEP': {'attribs': ['atomType',
                                                                      'spin',
                                                                      'branch',
                                                                      'branchLowest',
                                                                      'branchHighest',
                                                          ...
                                                          'simple': [],
                                                          'text': []},
                        './energyParameters/heloAtomicEP': {'attribs': ['atomType',
                                                                        'spin',
                                                                        'branch',
                                                                        'branchLowest',
                                                                        'branchHighest',
                                                            ...
                                                            'simple': [],
                                                            'text': []},
                        './energyParameters/loAtomicEP': {'attribs': ['atomType',
                                                                      'spin',
                                                                      'branch',
                                                                      'branchLowest',
                                                                      'branchHighest',
                                                          ...
                                                          'simple': [],
                                                          'text': []},
                        './energyParameters/vacuumEP': {'attribs': ['vacuum',
                                                                    'spin',
                                                                    'vzIR',
                                                                    'vzInf',
                                                                    'value'],
                        ...
                        './ldaUDensityMatrix/densityMatrixFor': {'attribs': ['spin',
                                                                             'atomType',
                                                                             'uIndex',
                                                                             'l',
                                                                             'U',
                                                                 ...
                                                                 'simple': [],
                                                                 'text': []},
                        './ldaUDensityMatrixConvergence': {'attribs': [],
                                                           'optional': ['distance'],
                                                           'optional_attribs': [],
                                                           'order': ['distance'],
                                                           'several': ['distance'],
                                                           'simple': ['distance'],
                                                           'text': []},
                        './ldaUDensityMatrixConvergence/distance': {'attribs': ['spin',
                                                                                'distance'],
                                                                    'optional': [],
                                                                    'optional_attribs': [],
                                                                    'order': [],
                                                                    ...
                                                                    'simple': [],
                                                                    'text': []},
                        './magneticMomentsInMTSpheres': {'attribs': ['units'],
                                                         ...
                                                         'text': []},
                        './magneticMomentsInMTSpheres/magneticMoment': {'attribs': ['atomType',
                                                                                    'moment',
                                                                                    'spinUpCharge',
                                                                                    'spinDownCharge'],
                                                                        'optional': [],
                        ...
                        './noncollinearTorgue': {'attribs': [],
                                                 ...
                                                 'simple': ['torgue'],
                                                 'text': []},
                        './noncollinearTorgue/torgue': {'attribs': ['atomType',
                                                                    'sigma_x',
                                                                    'sigma_y',
                                                                    'sigma_z',
                                                                    'units'],
                                                        ...
                                                        'simple': [],
                                                        'text': []},
                        './onSiteExchangeSplitting': {'attribs': [],
                                                      'optional': ['excSplit'],
                                                      'optional_attribs': [],
                                                      'order': ['excSplit'],
                                                      'several': ['excSplit'],
                                                      'simple': ['excSplit'],
                                                      'text': []},
                        './onSiteExchangeSplitting/excSplit': {'attribs': ['atomType',
                                                                           'l',
                                                                           'Delta',
                                                                           'units'],
                                                               'optional': [],
                                                               ...
                                                               'simple': [],
                                                               'text': []},
                        './orbitalMagneticMomentsInMTSpheres': {'attribs': ['units'],
                                                                ...
                                                                'simple': ['orbMagMoment'],
                                                                'text': []},
                        './orbitalMagneticMomentsInMTSpheres/orbMagMoment': {'attribs': ['atomType',
                                                                                         'moment',
                                                                                         'spinUpCharge',
                                                                                         'spinDownCharge'],
                                                                             'optional': [],
                        ...
                        './rdmft': {'attribs': ['energy'],
                                    ...
                                    'simple': [],
                                    'text': []},
                        './rdmft/occupations': {'attribs': ['spin', 'kpoint'],
                                                'optional': ['state'],
                                                'optional_attribs': [],
                                                'order': ['state'],
                                                'several': ['state'],
                                                'simple': ['state'],
                                                'text': []},
                        './rdmft/occupations/state': {'attribs': ['index',
                                                                  'energy',
                                                                  'occupation'],
                                                      'optional': [],
                                                      'optional_attribs': [],
                        ...
                        './spinorbitTorgue': {'attribs': [],
                                              ...
                                              'simple': ['torgue'],
                                              'text': []},
                        './spinorbitTorgue/torgue': {'attribs': ['atomType',
                                                                 'sigma_x',
                                                                 'sigma_y',
                                                                 'sigma_z',
                                                                 'units'],
                                                     ...
                                                     'simple': [],
                                                     'text': []},
                        './sumValenceSingleParticleEnergies': {'attribs': ['value',
                                                                           'units'],
                                                               'optional': [],
                                                               'optional_attribs': ['units'],
                                                               'order': [],
                        ...
                        './timing/timer': {'attribs': ['name',
                                           ...
                                           'simple': [],
                                           'text': []},
                        './totalEnergy': {'attribs': ['value',
                                                      'units',
                                                      'comment'],
                                          'optional': ['sumOfEigenvalues',
                                          ...
                                          'simple': ['sumOfEigenvalues',
                                                     ...
                                                     'extrapolationTo0K'],
                                          'text': []},
                        './totalEnergy/FockExchangeEnergyCore': {'attribs': ['value',
                                                                             'units'],
                                                                 'optional': [],
                                                                 'optional_attribs': ['units'],
                                                                 'order': [],
                                                                 ...
                                                                 'simple': [],
                                                                 'text': []},
                        './totalEnergy/FockExchangeEnergyValence': {'attribs': ['value',
                                                                                'units'],
                                                                    'optional': [],
                                                                    'optional_attribs': ['units'],
                                                                    'order': [],
                                                                    ...
                                                                    'simple': [],
                                                                    'text': []},
                        './totalEnergy/atomTypeDependentContributions': {'attribs': ['atomType'],
                                                                         'optional': ['electronNucleiInteractionDifferentMTs',
                                                                                      'MadelungTerm'],
                                                                         'optional_attribs': [],
                                                                         'order': ['electronNucleiInteractionDifferentMTs',
                                                                                   'MadelungTerm'],
                                                                         'several': [],
                                                                         'simple': ['electronNucleiInteractionDifferentMTs',
                                                                                    'MadelungTerm'],
                                                                         'text': []},
                        './totalEnergy/atomTypeDependentContributions/MadelungTerm': {'attribs': ['value',
                                                                                                  'units'],
                                                                                      'optional': [],
                                                                                      'optional_attribs': ['units'],
                                                                                      'order': [],
                                                                                      ...
                                                                                      'simple': [],
                                                                                      'text': []},
                        './totalEnergy/atomTypeDependentContributions/electronNucleiInteractionDifferentMTs': {'attribs': ['value',
                                                                                                                           'units'],
                                                                                                               'optional': [],
                                                                                                               'optional_attribs': ['units'],
                                                                                                               'order': [],
                                                                                                               ...
                                                                                                               'simple': [],
                                                                                                               'text': []},
                        './totalEnergy/chargeDenXCDenIntegral': {'attribs': ['value',
                                                                             'units'],
                                                                 'optional': [],
                                                                 'optional_attribs': ['units'],
                                                                 'order': [],
                                                                 ...
                                                                 'simple': [],
                                                                 'text': []},
                        './totalEnergy/densityCoulombPotentialIntegral': {'attribs': ['value',
                                                                                      'units'],
                                                                          'optional': [],
                                                                          'optional_attribs': ['units'],
                                                                          'order': [],
                                                                          ...
                                                                          'simple': [],
                                                                          'text': []},
                        './totalEnergy/densityEffectivePotentialIntegral': {'attribs': ['value',
                                                                                        'units'],
                                                                            'optional': [],
                                                                            'optional_attribs': ['units'],
                                                                            'order': [],
                                                                            ...
                                                                            'simple': [],
                                                                            'text': []},
                        './totalEnergy/dftUCorrection': {'attribs': ['value',
                                                                     'units'],
                                                         'optional': [],
                                                         'optional_attribs': ['units'],
                                                         'order': [],
                                                         ...
                                                         'simple': [],
                                                         'text': []},
                        './totalEnergy/extrapolationTo0K': {'attribs': ['value',
                                                                        'units'],
                                                            'optional': [],
                                                            'optional_attribs': ['units'],
                                                            'order': [],
                                                            ...
                                                            'simple': [],
                                                            'text': []},
                        './totalEnergy/freeEnergy': {'attribs': ['value',
                                                                 'units'],
                                                     'optional': [],
                                                     'optional_attribs': ['units'],
                                                     'order': [],
                                                     ...
                                                     'simple': [],
                                                     'text': []},
                        './totalEnergy/sumOfEigenvalues': {'attribs': ['value',
                                                                       'units'],
                                                           'optional': ['coreElectrons',
                                                                        'valenceElectrons'],
                                                           'optional_attribs': ['units'],
                                                           'order': ['coreElectrons',
                                                                     'valenceElectrons'],
                                                           'several': [],
                                                           'simple': ['coreElectrons',
                                                                      'valenceElectrons'],
                                                           'text': []},
                        './totalEnergy/sumOfEigenvalues/coreElectrons': {'attribs': ['value',
                                                                                     'units'],
                                                                         'optional': [],
                                                                         'optional_attribs': ['units'],
                                                                         'order': [],
                                                                         ...
                                                                         'simple': [],
                                                                         'text': []},
                        './totalEnergy/sumOfEigenvalues/valenceElectrons': {'attribs': ['value',
                                                                                        'units'],
                                                                            'optional': [],
                                                                            'optional_attribs': ['units'],
                                                                            'order': [],
                                                                            ...
                                                                            'simple': [],
                                                                            'text': []},
                        './totalEnergy/tkbTimesEntropy': {'attribs': ['value',
                                                                      'units'],
                                                          'optional': [],
                                                          'optional_attribs': ['units'],
                                                          'order': [],
                                                          ...
                                                          'simple': [],
                                                          'text': []},
                        './totalForcesOnRepresentativeAtoms': {'attribs': ['units'],
                                                               'optional': ['forceTotal'],
                                                               'optional_attribs': ['units'],
                                                               'order': ['forceTotal'],
                                                               'several': ['forceTotal'],
                                                               'simple': ['forceTotal'],
                                                               'text': []},
                        './totalForcesOnRepresentativeAtoms/forceTotal': {'attribs': ['atomType',
                                                                                      'x',
                                                                                      'y',
                                                                                      'z',
                                                                                      'F_x',
                        ...
                        './valenceDensity': {'attribs': [],
                                             ...
                                             'simple': ['spinDependentCharge',
                                                        'totalCharge'],
                                             'text': []},
                        './valenceDensity/fixedCharges': {'attribs': [],
                                                          'optional': ['spinDependentCharge',
                                                                       'totalCharge'],
                                                          'optional_attribs': [],
                                                          'order': ['spinDependentCharge',
                                                          ...
                                                          'simple': ['spinDependentCharge',
                                                                     'totalCharge'],
                                                          'text': []},
                        './valenceDensity/fixedCharges/spinDependentCharge': {'attribs': ['spin',
                                                                                          'total',
                                                                                          'interstitial',
                                                                                          'mtSpheres',
                                                                                          'vacuum1',
                                                                              ...
                                                                              'simple': [],
                                                                              'text': []},
                        './valenceDensity/fixedCharges/totalCharge': {'attribs': ['value',
                                                                                  'units'],
                                                                      'optional': [],
                                                                      'optional_attribs': ['units'],
                                                                      'order': [],
                                                                      ...
                                                                      'simple': [],
                                                                      'text': []},
                        './valenceDensity/mtCharges': {'attribs': ['spin'],
                                                       'optional': ['mtCharge',
                                                                    'mtJcharge'],
                                                       'optional_attribs': ['spin'],
                                                       'order': ['mtCharge',
                                                       ...
                                                       'simple': ['mtCharge'],
                                                       'text': []},
                        './valenceDensity/mtCharges/mtCharge': {'attribs': ['atomType',
                                                                            'total',
                                                                            's',
                                                                            'p',
                                                                            'd',
                                                                ...
                                                                'simple': [],
                                                                'text': []},
                        './valenceDensity/mtCharges/mtJcharge': {'attribs': ['atomType'],
                                                                 'optional': [],
                                                                 'optional_attribs': [],
                                                                 'order': ['lowJ',
                                                                           'highJ'],
                                                                 ...
                                                                 'simple': ['lowJ',
                                                                            'highJ'],
                                                                 'text': []},
                        './valenceDensity/mtCharges/mtJcharge/highJ': {'attribs': ['p',
                                                                                   'd',
                                                                                   'f'],
                                                                       'optional': [],
                                                                       'optional_attribs': [],
                                                                       ...
                                                                       'simple': [],
                                                                       'text': []},
                        './valenceDensity/mtCharges/mtJcharge/lowJ': {'attribs': ['p',
                                                                                  'd',
                                                                                  'f'],
                                                                      'optional': [],
                                                                      'optional_attribs': [],
                                                                      ...
                                                                      'simple': [],
                                                                      'text': []},
                        './valenceDensity/spinDependentCharge': {'attribs': ['spin',
                                                                             'total',
                                                                             'interstitial',
                                                                             'mtSpheres',
                                                                             'vacuum1',
                                                                 ...
                                                                 'simple': [],
                                                                 'text': []},
                        './valenceDensity/totalCharge': {'attribs': ['value',
                                                                     'units'],
                                                         'optional': [],
                                                         'optional_attribs': ['units'],
                                                         'order': [],
                                                         ...
                                                         'simple': [],
                                                         'text': []}},
 'iteration_tag_paths': {'Angle': './Forcetheorem_MAE/Angle',
                         'Config': './Forcetheorem_JIJ/Config',
                         'Entry': ['./Forcetheorem_DMI/Entry',
                         ...
                         'fixedCharges': ['./valenceDensity/fixedCharges',
                         ...
                         'torgue': ['./noncollinearTorgue/torgue',
                                    './spinorbitTorgue/torgue'],
 ...
 'iteration_unique_attribs': {'Configs': './Forcetheorem_JIJ',
                              'numberForCurrentRun': './',
                              'overallNumber': './',
                              'qpoints': './Forcetheorem_DMI',
                              'qvectors': './Forcetheorem_SSDISP'},
 'iteration_unique_path_attribs': {'Angles': ['./Forcetheorem_DMI',
                                              './Forcetheorem_MAE'],
                                   'units': ['./Forcetheorem_DMI',
                                             './Forcetheorem_JIJ',
                                             './Forcetheorem_MAE',
                                             './Forcetheorem_SSDISP']},
 'omitt_contained_tags': ['scfLoop',
                          'eigenvalues',
                          'onSiteExchangeSplitting',
                          'noncollinearTorgue',
                          'spinorbitTorgue',
                          'ldaUDensityMatrix',
                          'ldaUDensityMatrixConvergence'],
 'other_attribs': {'atomType': ['/fleurOutput/numericalParameters/volumes/mtVolume'],
 ...
 'simple_elements': {'additionalCompilerFlags': [{'length': 'unbounded',
                     ...
                     'targetStructureClass': [{'length': 'unbounded',
                                               'type': ['string']}]},
 'tag_info': {'/fleurOutput': {'attribs': ['fleurOutputVersion'],
                               'optional': ['programVersion',
                                            'parallelSetup',
                                            'startDateAndTime',
                                            'fleurInput',
                                            'numericalParameters',
                               ...
                               'order': ['programVersion',
                                         ...
                                         'endDateAndTime'],
                               'several': [],
                               'simple': ['programVersion',
                                          'startDateAndTime',
                                          'fleurInput',
                                          'ERROR',
                                          'endDateAndTime'],
                               'text': []},
              '/fleurOutput/ERROR': {'attribs': ['Message'],
                                     'optional': [],
                                     'optional_attribs': [],
                                     'order': [],
                                     'several': [],
                                     'simple': [],
                                     'text': []},
              '/fleurOutput/endDateAndTime': {'attribs': ['date',
                                                          'time',
                                                          'zone'],
                                              'optional': [],
                                              'optional_attribs': [],
                                              ...
                                              'simple': [],
                                              'text': []},
              '/fleurOutput/numericalParameters': {'attribs': [],
                                                   'optional': [],
                                                   'optional_attribs': [],
                                                   'order': ['atomsInCell',
                                                             'basis',
                                                   ...
                                                   'simple': ['atomsInCell',
                                                              ...
                                                              'bands'],
                                                   'text': []},
              '/fleurOutput/numericalParameters/atomsInCell': {'attribs': ['nat',
                                                                           'ntype',
                                                                           'jmtd',
                                                                           'n_u',
                                                                           'n_hia'],
                                                               ...
                                                               'simple': [],
                                                               'text': []},
              '/fleurOutput/numericalParameters/bands': {'attribs': ['numbands'],
                                                         'optional': [],
                                                         'optional_attribs': [],
                                                         'order': [],
                                                         'several': [],
                                                         'simple': [],
                                                         'text': []},
              '/fleurOutput/numericalParameters/basis': {'attribs': ['nvd',
                                                                     'lmaxd',
                                                                     'nlotot'],
                                                         'optional': [],
                                                         'optional_attribs': [],
                                                         ...
                                                         'simple': [],
                                                         'text': []},
              '/fleurOutput/numericalParameters/density': {'attribs': ['ng3',
                                                                       'ng2'],
                                                           'optional': [],
                                                           'optional_attribs': [],
                                                           'order': [],
                                                           ...
                                                           'simple': [],
                                                           'text': []},
              '/fleurOutput/numericalParameters/kPointList': {'attribs': ['weightScale',
                                                                          'count'],
                                                              'optional': ['kPoint'],
                                                              'optional_attribs': [],
                                                              'order': ['kPoint'],
                                                              ...
                                                              'simple': ['kPoint'],
                                                              'text': ['kPoint']},
              '/fleurOutput/numericalParameters/volumes': {'attribs': ['unitCell',
                                                                       'interstitial',
                                                                       'omegaTilda',
                                                                       'surfaceArea',
                                                                       'z1'],
                                                           'optional': ['mtVolume'],
                                                           'optional_attribs': ['omegaTilda',
                                                                                'surfaceArea',
                                                                                'z1'],
                                                           'order': ['mtVolume'],
                                                           'several': ['mtVolume'],
                                                           'simple': ['mtVolume'],
                                                           'text': []},
              '/fleurOutput/numericalParameters/volumes/mtVolume': {'attribs': ['atomType',
                                                                                'mtRadius',
                                                                                'mtVolume'],
                                                                    'optional': [],
                                                                    'optional_attribs': [],
                                                                    ...
                                                                    'simple': [],
                                                                    'text': []},
              '/fleurOutput/parallelSetup': {'attribs': [],
                                             'optional': ['openMP',
                                                          'mpi',
                                                          'mem'],
                                             'optional_attribs': [],
                                             ...
                                             'text': []},
              '/fleurOutput/parallelSetup/mem': {'attribs': ['memoryPerNode'],
                                                 'optional': [],
                                                 'optional_attribs': [],
                                                 'order': [],
                                                 'several': [],
                                                 'simple': [],
                                                 'text': []},
              '/fleurOutput/parallelSetup/mpi': {'attribs': ['mpiProcesses'],
                                                 'optional': [],
                                                 'optional_attribs': [],
                                                 'order': [],
                                                 'several': [],
                                                 'simple': [],
                                                 'text': []},
              '/fleurOutput/parallelSetup/openMP': {'attribs': ['ompThreads'],
                                                    'optional': [],
                                                    'optional_attribs': [],
                                                    'order': [],
                                                    'several': [],
                                                    'simple': [],
                                                    'text': []},
              '/fleurOutput/programVersion': {'attribs': ['version'],
                                              'optional': ['compilationInfo',
                                                           'gitInfo',
                                              ...
                                              'order': ['compilationInfo',
                                                        ...
                                                        'additionalCompilerFlags'],
                                              'several': [],
                                              'simple': ['compilationInfo',
                                                         'gitInfo',
                                                         'targetComputerArchitectures',
                                                         'precision',
                                                         'targetStructureClass',
                                                         'additionalCompilerFlags'],
                                              'text': ['targetComputerArchitectures',
                                                       'targetStructureClass',
                                                       'additionalCompilerFlags']},
              '/fleurOutput/programVersion/compilationInfo': {'attribs': ['date',
                                                                          'user',
                                                                          'host',
                                                                          'flag',
                                                                          'link'],
                                                              ...
                                                              'simple': [],
                                                              'text': []},
              '/fleurOutput/programVersion/gitInfo': {'attribs': ['version',
                                                                  'lastCommitHash',
                                                                  'branch'],
                                                      'optional': [],
                                                      'optional_attribs': [],
                                                      ...
                                                      'simple': [],
                                                      'text': []},
              '/fleurOutput/programVersion/precision': {'attribs': ['type'],
                                                        'optional': [],
                                                        'optional_attribs': [],
                                                        'order': [],
                                                        'several': [],
              ...
              '/fleurOutput/scfLoop': {'attribs': [],
                                       ...
                                       'simple': [],
                                       'text': []},
              '/fleurOutput/scfLoop/iteration': {'attribs': ['numberForCurrentRun',
                                                             'overallNumber'],
                                                 'optional': ['Forcetheorem_Loop',
                                                              'Forcetheorem_SSDISP',
                                                              'Forcetheorem_DMI',
                                                              'Forcetheorem_MAE',
                                                              'Forcetheorem_JIJ'],
                                                 ...
                                                 'simple': [],
                                                 'text': []},
              '/fleurOutput/startDateAndTime': {'attribs': ['date',
                                                            'time',
                                                            'zone'],
                                                'optional': [],
                                                'optional_attribs': [],
                                                ...
                                                'simple': [],
                                                'text': []}},
 'tag_paths': {'ERROR': '/fleurOutput/ERROR',
 ...
 'unique_attribs': {'Message': '/fleurOutput/ERROR',
                    'additionalCompilerFlags': '/fleurOutput/programVersion/additionalCompilerFlags',
 ...
 'unique_path_attribs': {'date': ['/fleurOutput/programVersion/compilationInfo',
                                  '/fleurOutput/startDateAndTime',
                                  '/fleurOutput/endDateAndTime'],
                         'time': ['/fleurOutput/startDateAndTime',
                                  '/fleurOutput/endDateAndTime'],
                         'version': ['/fleurOutput/programVersion',
                                     '/fleurOutput/programVersion/gitInfo'],
                         'zone': ['/fleurOutput/startDateAndTime',
                                  '/fleurOutput/endDateAndTime']}}
