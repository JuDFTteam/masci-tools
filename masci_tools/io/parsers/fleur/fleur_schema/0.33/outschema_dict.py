...
schema_dict = {'attrib_paths': {'No': ['/fleurOutput/scfLoop/iteration/Forcetheorem_Loop_MAE',
                         '/fleurOutput/scfLoop/iteration/Forcetheorem_Loop_JIJ'],
                  'Q-vec': ['/fleurOutput/scfLoop/iteration/Forcetheorem_Loop_SSDISP',
                  ...
                  'd': ['/fleurOutput/startDensityCharges/mtCharges/mtCharge',
                        '/fleurOutput/scfLoop/readDensityCharges/mtCharges/mtCharge',
                  ...
                  'date': ['/fleurOutput/programVersion/compilationInfo',
                           '/fleurOutput/startDateAndTime',
                           '/fleurOutput/endDateAndTime'],
                  'ev-sum': '/fleurOutput/scfLoop/iteration/Forcetheorem_SSDISP/Entry',
                  'f': ['/fleurOutput/startDensityCharges/mtCharges/mtCharge',
                        '/fleurOutput/scfLoop/readDensityCharges/mtCharges/mtCharge',
                        '/fleurOutput/startDensityCharges/mtCharges/mtJcharge/lowJ',
                        '/fleurOutput/scfLoop/readDensityCharges/mtCharges/mtJcharge/lowJ',
                        '/fleurOutput/startDensityCharges/mtCharges/mtJcharge/highJ',
                  ...
                  'mtSpheres': ['/fleurOutput/startDensityCharges/spinDependentCharge',
                                '/fleurOutput/scfLoop/readDensityCharges/spinDependentCharge'],
                  ...
                  'p': ['/fleurOutput/startDensityCharges/mtCharges/mtCharge',
                        '/fleurOutput/scfLoop/readDensityCharges/mtCharges/mtCharge',
                        '/fleurOutput/startDensityCharges/mtCharges/mtJcharge/lowJ',
                        '/fleurOutput/scfLoop/readDensityCharges/mtCharges/mtJcharge/lowJ',
                        '/fleurOutput/startDensityCharges/mtCharges/mtJcharge/highJ',
                        '/fleurOutput/scfLoop/readDensityCharges/mtCharges/mtJcharge/highJ'],
                  'q': '/fleurOutput/scfLoop/iteration/Forcetheorem_SSDISP/Entry',
                  'qvectors': '/fleurOutput/scfLoop/iteration/Forcetheorem_SSDISP',
                  's': ['/fleurOutput/startDensityCharges/mtCharges/mtCharge',
                        '/fleurOutput/scfLoop/readDensityCharges/mtCharges/mtCharge'],
                  'spin': ['/fleurOutput/startDensityCharges/mtCharges',
                  ...
                  'time': ['/fleurOutput/startDateAndTime',
                           '/fleurOutput/endDateAndTime'],
                  'total': ['/fleurOutput/startDensityCharges/mtCharges/mtCharge',
                            '/fleurOutput/scfLoop/readDensityCharges/mtCharges/mtCharge',
                            '/fleurOutput/startDensityCharges/spinDependentCharge',
                            '/fleurOutput/scfLoop/readDensityCharges/spinDependentCharge'],
                  'type': '/fleurOutput/programVersion/precision',
                  'unitCell': '/fleurOutput/numericalParameters/volumes',
                  'units': ['/fleurOutput/startDensityCharges/totalCharge',
                            '/fleurOutput/scfLoop/readDensityCharges/totalCharge'],
                  'user': '/fleurOutput/programVersion/compilationInfo',
                  'vacuum1': ['/fleurOutput/startDensityCharges/spinDependentCharge',
                              '/fleurOutput/scfLoop/readDensityCharges/spinDependentCharge'],
                  'vacuum2': ['/fleurOutput/startDensityCharges/spinDependentCharge',
                              '/fleurOutput/scfLoop/readDensityCharges/spinDependentCharge'],
                  'value': ['/fleurOutput/startDensityCharges/totalCharge',
                            '/fleurOutput/scfLoop/readDensityCharges/totalCharge'],
 ...
 'iteration_attrib_paths': {'Delta': '/onSiteExchangeSplitting/excSplit',
