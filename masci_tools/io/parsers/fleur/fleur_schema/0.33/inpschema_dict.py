...
schema_dict = {'attrib_types': {'Gmax': ['float_expression'],
 ...
 'tag_info': {'/fleurInput': {'attribs': ['fleurInputVersion'],
              ...
              '/fleurInput/cell/bzIntegration/kPointLists/kPointList/kPoint': {'attribs': ['weight',
                                                                               ...
                                                                               'simple': [],
                                                                               'text': []},
              '/fleurInput/cell/bzIntegration/kPointLists/kPointList/tetraeder': {'attribs': ['ntet'],
                                                                                  'optional': [],
                                                                                  'order': ['tet'],
                                                                                  'several': ['tet'],
                                                                                  'simple': ['tet'],
                                                                                  'text': ['tet']},
              '/fleurInput/cell/bzIntegration/kPointLists/kPointList/triangles': {'attribs': ['ntria'],
                                                                                  'optional': [],
                                                                                  'order': ['tria'],
                                                                                  'several': ['tria'],
                                                                                  'simple': ['tria'],
