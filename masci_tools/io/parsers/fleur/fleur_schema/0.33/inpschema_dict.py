...
schema_dict = {'attrib_paths': {'Gmax': '/fleurInput/calculationSetup/cutoffs/@Gmax',
 ...
 'attrib_types': {'Gmax': 'float',
                  ...
                  'zrfs1': 'switch',
                  'zsigma': 'float'},
 'basic_types': {'AtomPosType': {'base_types': ['float'], 'length': 3},
                 ...
                 'FleurBoolVecType': {'base_types': ['switch'],
                                      'length': 'unbounded'},
                 'FleurDouble2DVecType': {'base_types': ['float'], 'length': 2},
                 'FleurDouble3DVecType': {'base_types': ['float'], 'length': 3},
                 'FleurDoubleVecType': {'base_types': ['float'],
                                        'length': 'unbounded'},
 ...
 'simple_elements': {'a1': {'length': 1, 'type': ['float']},
                     ...
                     'relPos': {'length': 3, 'type': ['float']},
                     'row-1': [{'length': 2, 'type': ['float']},
                               {'length': 3, 'type': ['float']},
                               {'length': 4, 'type': ['float']}],
                     'row-2': [{'length': 2, 'type': ['float']},
                               {'length': 3, 'type': ['float']},
                               {'length': 4, 'type': ['float']}],
                     'row-3': [{'length': 3, 'type': ['float']},
                               {'length': 4, 'type': ['float']}],
