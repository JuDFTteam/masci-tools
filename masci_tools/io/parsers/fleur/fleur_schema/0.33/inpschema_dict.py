...
schema_dict = {'attrib_types': {'Gmax': 'float_expression',
 ...
 'tag_info': {'/fleurInput': {'attribs': ['fleurInputVersion'],
              ...
              '/fleurInput/calculationSetup/xcFunctional/xcParams': {'attribs': ['igrd',
                                                                                 ...
                                                                                 'idsprs',
                                                                                 'chng']},
              '/fleurInput/cell': {'order': ['bzIntegration',
                                             'symmetryOperations',
                                             'bulkLattice',
                                             'filmLattice']},
              ...
              '/fleurInput/cell/bzIntegration/kPointLists': {'order': ['kPointList'],
                                                             'several': ['kPointList']},
              ...
              '/fleurInput/cell/filmLattice/vacuumEnergyParameters': {'attribs': ['vacuum',
                                                                                  'spinUp',
                                                                                  'spinDown']},
              '/fleurInput/cell/symmetryOperations': {'order': ['symOp'],
                                                      'several': ['symOp']},
              '/fleurInput/cell/symmetryOperations/symOp': {'order': ['row-1',
                                                                      'row-2',
                                                                      'row-3'],
                                                            'simple': ['row-1',
                                                                       'row-2',
              ...
              '/fleurInput/output/coreSpectrum': {'attribs': ['eKin',
                                                  ...
                                                  'order': ['edgeIndices'],
                                                  'simple': ['edgeIndices']},
              '/fleurInput/output/juPhon': {'attribs': ['l_potout',
                                                        'l_eigout']},
