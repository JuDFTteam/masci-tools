...
schema_dict = {'attrib_paths': {'Gmax': '/fleurInput/calculationSetup/cutoffs/@Gmax',
 ...
 'attrib_types': {'Gmax': 'float_expression',
 ...
 'basic_types': {'AtomPosType': {'base_types': ['float_expression'],
                                 'length': 3},
                 ...
                 'FleurBoolVecType': {'base_types': ['switch'],
                                      'length': 'unbounded'},
                 'FleurDouble2DVecType': {'base_types': ['float_expression'],
                                          'length': 2},
                 'FleurDouble3DVecType': {'base_types': ['float_expression'],
                                          'length': 3},
                 'FleurDoubleVecType': {'base_types': ['float_expression'],
                                        'length': 'unbounded'},
                 ...
                 'KPointListPurposeEnum': {'base_types': ['string'],
                                           'length': 1},
                 'KPointType': {'base_types': ['float_expression'],
                                'length': 3},
                 'LatticeParameterType': {'base_types': ['float_expression'],
                                          'length': 1},
                 ...
                 'SpecialPointType': {'base_types': ['float_expression'],
                                      'length': 3},
 ...
 'simple_elements': {'a1': {'length': 1, 'type': ['float_expression']},
                     'a2': {'length': 1, 'type': ['float_expression']},
                     'absPos': {'length': 3, 'type': ['float_expression']},
                     'c': {'length': 1, 'type': ['float_expression']},
                     ...
                     'filmPos': {'length': 3, 'type': ['float_expression']},
                     'jobList': {'length': 'unbounded', 'type': ['string']},
                     'kPoint': {'length': 3, 'type': ['float_expression']},
                     ...
                     'qsc': {'length': 3, 'type': ['float_expression']},
                     'qss': {'length': 3, 'type': ['float_expression']},
                     'relPos': {'length': 3, 'type': ['float_expression']},
                     'row-1': [{'length': 2, 'type': ['float_expression']},
                               {'length': 3, 'type': ['float_expression']},
                               {'length': 4, 'type': ['float']}],
                     'row-2': [{'length': 2, 'type': ['float_expression']},
                               {'length': 3, 'type': ['float_expression']},
                               {'length': 4, 'type': ['float']}],
                     'row-3': [{'length': 3, 'type': ['float_expression']},
                               {'length': 4, 'type': ['float']}],
 ...
 'tag_attribs': {'/fleurInput': ['fleurInputVersion'],
                 ...
                 '/fleurInput/atomGroups/atomGroup/atomicCutoffs': ['lmax',
                                                                    'lnonsphr',
                                                                    'lmaxAPW'],
                 '/fleurInput/atomGroups/atomGroup/cFCoeffs': ['chargeDensity',
                                                               'potential',
                                                               'remove4f'],
                 '/fleurInput/atomGroups/atomGroup/energyParameters': ['s',
                                                                       'p',
                 ...
                 '/fleurInput/atomSpecies/species/ldaHIA': ['l',
                                                            ...
                                                            'kkintgrCutoff',
                                                            'label'],
                 '/fleurInput/atomSpecies/species/ldaHIA/addArg': ['key',
                                                                   'value'],
                 '/fleurInput/atomSpecies/species/ldaHIA/cFCoeff': ['l',
                                                                    'm',
                                                                    'value'],
                 ...
                 '/fleurInput/atomSpecies/species/lo': ['type',
                                                        ...
                                                        'n',
                                                        'eDeriv'],
                 '/fleurInput/atomSpecies/species/modInitDen': ['magMom',
                                                                'flipSpinPhi',
                                                                'flipSpinTheta',
                                                                'flipSpinScale'],
                 ...
                 '/fleurInput/calculationSetup/greensFunction/contourDOS': ['n',
                                                                            ...
                                                                            'l_fermi',
                                                                            'label'],
                 '/fleurInput/calculationSetup/greensFunction/contourRectangle': ['n1',
                                                                                  'n2',
                                                                                  'n3',
                                                                                  'nmatsub',
                                                                                  'sigma',
                 ...
                 '/fleurInput/calculationSetup/greensFunction/contourSemicircle': ['n',
                                                                                   ...
                                                                                   'alpha',
                                                                                   'label'],
                 '/fleurInput/calculationSetup/greensFunction/realAxis': ['ne',
                                                                          'ellow',
                                                                          'elup'],
                 '/fleurInput/calculationSetup/ldaHIA': ['itmaxHubbard1',
                                                         'beta',
                                                         'minoccDistance',
                                                         'minmatDistance',
                                                         'n_occpm',
                 ...
                 '/fleurInput/calculationSetup/magnetism/mtNocoParams': ['l_mtNocoPot',
                                                                         ...
                                                                         'mix_RelaxWeightOffD',
                                                                         'mix_constr'],
                 '/fleurInput/calculationSetup/magnetism/sourceFreeMag': ['l_sourceFree',
                                                                          'l_scaleMag',
                                                                          'mag_scale'],
                 ...
                 '/fleurInput/calculationSetup/xcFunctional/LibXCName': ['exchange',
                                                                         ...
                                                                         'etot_exchange',
                                                                         'etot_correlation'],
                 '/fleurInput/calculationSetup/xcFunctional/ggaPrinting': ['iggachk',
                                                                           'idsprs0',
                                                                           'idsprsl',
                                                                           'idsprsi',
                                                                           'idsprsv'],
                 '/fleurInput/calculationSetup/xcFunctional/xcParams': ['igrd',
                                                                        'lwb',
                                                                        'ndvgrd',
                                                                        'idsprs',
                                                                        'chng'],
                 '/fleurInput/cell/bulkLattice': ['scale'],
                 '/fleurInput/cell/bulkLattice/a1': ['scale'],
                 '/fleurInput/cell/bulkLattice/a2': ['scale'],
                 '/fleurInput/cell/bulkLattice/c': ['scale'],
                 '/fleurInput/cell/bzIntegration': ['valenceElectrons',
                                                    'mode',
                                                    'fermiSmearingEnergy',
                                                    'fermiSmearingTemp',
                                                    'l_bloechl'],
                 '/fleurInput/cell/bzIntegration/kPointListSelection': ['listName'],
                 '/fleurInput/cell/bzIntegration/kPointLists/kPointList': ['name',
                                                                           'type',
                                                                           'count',
                                                                           'nx',
                                                                           'ny',
                                                                           'nz'],
                 '/fleurInput/cell/bzIntegration/kPointLists/kPointList/kPoint': ['weight',
                                                                                  'label'],
                 '/fleurInput/cell/bzIntegration/kPointLists/kPointList/tetraeder': ['ntet'],
                 '/fleurInput/cell/bzIntegration/kPointLists/kPointList/triangles': ['ntria'],
                 '/fleurInput/cell/filmLattice': ['scale', 'dVac', 'dTilda'],
                 '/fleurInput/cell/filmLattice/a1': ['scale'],
                 '/fleurInput/cell/filmLattice/a2': ['scale'],
                 ...
                 '/fleurInput/output': ['dos',
                                        ...
                                        'wannier',
                                        'eig66'],
                 '/fleurInput/output/bandDOS': ['all_atoms',
                                                'orbcomp',
                                                'jDOS',
                                                'minEnergy',
                                                'maxEnergy',
                 ...
                 '/fleurInput/output/coreSpectrum': ['eKin',
                                                     ...
                                                     'beta_Ex',
                                                     'I_initial'],
                 '/fleurInput/output/juPhon': ['l_potout', 'l_eigout'],
                 '/fleurInput/output/magneticCircularDichroism': ['mcd',
                                                                  'energyLo',
                                                                  'energyUp'],
                 '/fleurInput/output/plotting': ['iplot', 'polar', 'format'],
                 '/fleurInput/output/plotting/plot': ['cartesian',
                                                      'TwoD',
                                                      'grid',
                                                      'vec1',
                                                      'vec2',
                 ...
                 '/fleurInput/output/unfoldingBand': ['unfoldBand',
                                                      ...
                                                      'supercellY',
                                                      'supercellZ'],
                 '/fleurInput/output/vacuumDOS': ['vacdos',
                                                  'integ',
                                                  'star',
                                                  'nstars',
                                                  'locx1',
