...
schema_dict = {'_basic_types': {'AdditionalCompilerFlagsType': {'base_types': ['string'],
                                                  'length': 'unbounded'},
                  ...
                  'DoubleVecType': {'base_types': ['float'],
                                    'length': 'unbounded'},
                  'EParamSelectionEnum': {'base_types': ['string'],
                                          'length': 1},
                  ...
                  'NumBandsType': {'base_types': ['int', 'string'],
                                   'length': 1},
                  'PositionType': {'base_types': ['float'], 'length': 3},
                  'RDMFTFunctionalEnum': {'base_types': ['string'],
                                          'length': 1},
                  ...
                  'ZeroToOneNumberType': {'base_types': ['float'],
                                          'length': 1}},
 '_input_basic_types': {'AtomPosType': {'base_types': ['string'], 'length': 3},
                        'BZIntegrationModeEnum': {'base_types': ['string'],
                                                  'length': 1},
                        'CoreConfigEnum': {'base_types': ['string'],
                                           'length': 1},
                        'CoreSpecEdgeEnum': {'base_types': ['string'],
                                             'length': 1},
                        'CoreStateListType': {'base_types': ['string'],
                                              'length': 'unbounded'},
                        'DisplaceType': {'base_types': ['float'], 'length': 3},
                        'Double3DVecType': {'base_types': ['float'],
                                            'length': 3},
                        'Double4DVecType': {'base_types': ['float'],
                                            'length': 4},
                        'DoubleVecType': {'base_types': ['float'],
                                          'length': 'unbounded'},
                        'EParamSelectionEnum': {'base_types': ['string'],
                                                'length': 1},
                        'ElectronStateEnum': {'base_types': ['string'],
                                              'length': 1},
                        'FleurVersionType': {'base_types': ['string'],
                                             'length': 1},
                        'ForceMixEnum': {'base_types': ['string'], 'length': 1},
                        'IntegerVecType': {'base_types': ['int'],
                                           'length': 'unbounded'},
                        ...
                        'LatticeParameterType': {'base_types': ['string'],
                                                 'length': 1},
                        'MixingEnum': {'base_types': ['string'], 'length': 1},
                        'NobleGasConfigEnum': {'base_types': ['string'],
                                               'length': 1},
                        'NumBandsType': {'base_types': ['int', 'string'],
                                         'length': 1},
                        'PositionType': {'base_types': ['float'], 'length': 3},
                        'RDMFTFunctionalEnum': {'base_types': ['string'],
                                                'length': 1},
                        'SpecialPointType': {'base_types': ['string'],
                                             'length': 3},
                        'SpgrpEnum': {'base_types': ['string'], 'length': 1},
                        'SpinNumberType': {'base_types': ['int'], 'length': 1},
                        'String2DVecType': {'base_types': ['string'],
                                            'length': 2},
                        'String3DVecType': {'base_types': ['string'],
                                            'length': 3},
                        'StringVecType': {'base_types': ['string'],
                                          'length': 'unbounded'},
                        'TripleFleurBool': {'base_types': ['string'],
                                            'length': 1},
                        'ValenceStateListType': {'base_types': ['string'],
                                                 'length': 'unbounded'},
                        'XCFunctionalEnum': {'base_types': ['string'],
                                             'length': 1},
                        'ZeroToOneNumberType': {'base_types': ['float'],
                                                'length': 1}},
 'attrib_types': {'Angles': ['int'],
                  'Configs': ['int'],
                  'F_x': ['float'],
                  'F_y': ['float'],
                  'F_z': ['float'],
                  ...
                  'zone': ['string']},
 'input_tag': 'inputData',
 'iteration_other_attribs': {'F_x': ['./totalForcesOnRepresentativeAtoms/forceTotal'],
                             ...
                             'atomType': ['./energyParameters/atomicEP',
                             ...
                             'distance': ['./densityConvergence/chargeDensity',
 ...
 'iteration_tag_info': {'./FermiEnergy': {'attribs': ['value', 'units'],
                                          ...
                                          'simple': [],
                                          'text': []},
                        './Forcetheorem_DMI': {'attribs': ['Angles', 'qpoints'],
                                               'optional': ['Entry'],
                                               'optional_attribs': [],
                                               'order': ['Entry'],
                                               'several': ['Entry'],
                        ...
                        './Forcetheorem_DMI/Entry': {'attribs': ['q',
                                                     ...
                                                     'simple': [],
                                                     'text': []},
                        './Forcetheorem_JIJ': {'attribs': ['Configs'],
                                               'optional': ['Config'],
                                               'optional_attribs': [],
                                               'order': ['Config'],
                                               'several': ['Config'],
                        ...
                        './Forcetheorem_Loop': {'attribs': ['No'],
                                                ...
                                                'simple': [],
                                                'text': []},
                        './Forcetheorem_MAE': {'attribs': ['Angles'],
                                               'optional': ['Angle'],
                                               'optional_attribs': [],
                                               'order': ['Angle'],
                                               'several': ['Angle'],
                        ...
                        './totalEnergy': {'attribs': ['value',
                                          ...
                                          'several': ['sumOfEigenvalues',
                                                      ...
                                                      'freeEnergy',
                                                      'extrapolationTo0K'],
                                          'simple': ['densityCoulombPotentialIntegral',
                                                     'densityEffectivePotentialIntegral',
                                                     'chargeDenXCDenIntegral',
                                                     'FockExchangeEnergyValence',
                                                     'FockExchangeEnergyCore',
 ...
 'tag_info': {'/fleurOutput': {'attribs': ['fleurOutputVersion'],
              ...
              '/fleurOutput/startDateAndTime': {'attribs': ['date',
                                                ...
                                                'simple': [],
                                                'text': []}},
 'tag_paths': {'additionalCompilerFlags': '/fleurOutput/programVersion/additionalCompilerFlags',
 ...
 'unique_attribs': {'additionalCompilerFlags': '/fleurOutput/programVersion/additionalCompilerFlags',
