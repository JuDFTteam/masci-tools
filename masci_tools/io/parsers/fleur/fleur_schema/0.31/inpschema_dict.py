...
schema_dict = {
    ...
    'other_attribs': {
        ...
        'phi': ['/fleurInput/atomSpecies/species/ldaU', '/fleurInput/atomGroups/atomGroup/ldaU'],
        ...
        'theta': ['/fleurInput/atomSpecies/species/ldaU', '/fleurInput/atomGroups/atomGroup/ldaU'],
    ...
    'unique_path_attribs': {
        ...
        'filename': ['/fleurInput/cell/symmetryFile', '/fleurInput/calculationSetup/bzIntegration/kPointListFile'],
        'gamma': [
            '/fleurInput/calculationSetup/bzIntegration/kPointMesh',
            '/fleurInput/calculationSetup/bzIntegration/kPointCount',
            '/fleurInput/calculationSetup/bzIntegration/kPointDensity'
