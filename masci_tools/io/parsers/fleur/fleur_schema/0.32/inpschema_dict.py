...
schema_dict = {'attrib_types': {'Gmax': ['string'],
 ...
 'other_attribs': {'J': ['/fleurInput/atomSpecies/species/ldaU',
                   ...
                   'init_occ': ['/fleurInput/atomSpecies/species/ldaHIA',
                                '/fleurInput/atomGroups/atomGroup/ldaHIA'],
                   'jDOS': ['/fleurInput/atomGroups/atomGroup/relPos',
                            '/fleurInput/atomGroups/atomGroup/absPos',
                            '/fleurInput/atomGroups/atomGroup/filmPos'],
                   ...
                   'l_magn': ['/fleurInput/atomSpecies/species/nocoParams',
                              '/fleurInput/atomGroups/atomGroup/nocoParams'],
                   'l_relax': ['/fleurInput/atomSpecies/species/nocoParams',
                               '/fleurInput/atomGroups/atomGroup/nocoParams'],
                   ...
                   'orbcomp': ['/fleurInput/atomGroups/atomGroup/relPos',
                               '/fleurInput/atomGroups/atomGroup/absPos',
                               '/fleurInput/atomGroups/atomGroup/filmPos'],
                   ...
                   'vol': ['/fleurInput/calculationSetup/bzIntegration/kPointLists/kPointList/tetraeder/tet',
 ...
 'tag_info': {'/fleurInput': {'attribs': ['fleurInputVersion'],
              ...
              '/fleurInput/calculationSetup/bzIntegration/kPointListSelection': {'attribs': ['listName'],
                                                                                 ...
                                                                                 'simple': [],
                                                                                 'text': []},
              '/fleurInput/calculationSetup/bzIntegration/kPointLists': {'attribs': [],
                                                                         'optional': [],
                                                                         'order': ['kPointList'],
                                                                         'several': ['kPointList'],
                                                                         'simple': [],
              ...
              '/fleurInput/calculationSetup/spinSpiralQPointMesh': {'attribs': ['qx',
                                                                    ...
                                                                    'simple': [],
                                                                    'text': []},
              '/fleurInput/calculationSetup/symmetryOperations': {'attribs': [],
                                                                  'optional': [],
                                                                  'order': ['symOp'],
                                                                  'several': ['symOp'],
                                                                  'simple': [],
                                                                  'text': []},
              '/fleurInput/calculationSetup/symmetryOperations/symOp': {'attribs': [],
                                                                        'optional': [],
                                                                        'order': ['row-1',
                                                                                  'row-2',
                                                                                  'row-3'],
