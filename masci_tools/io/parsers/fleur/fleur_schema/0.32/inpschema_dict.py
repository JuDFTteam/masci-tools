...
schema_dict = {'attrib_paths': {'Gmax': '/fleurInput/calculationSetup/cutoffs/@Gmax',
 ...
 'tag_attribs': {'/fleurInput': ['fleurInputVersion'],
                 ...
                 '/fleurInput/calculationSetup/bzIntegration': ['valenceElectrons',
                                                                ...
                                                                'fermiSmearingTemp',
                                                                'l_bloechl'],
                 '/fleurInput/calculationSetup/bzIntegration/kPointListSelection': ['listName'],
                 '/fleurInput/calculationSetup/bzIntegration/kPointLists/kPointList': ['name',
                                                                                       'type',
                                                                                       'count',
                                                                                       'nx',
                                                                                       'ny',
                                                                                       'nz'],
                 '/fleurInput/calculationSetup/bzIntegration/kPointLists/kPointList/kPoint': ['weight',
                                                                                              'label'],
                 '/fleurInput/calculationSetup/bzIntegration/kPointLists/kPointList/tetraeder': ['ntet'],
                 '/fleurInput/calculationSetup/bzIntegration/kPointLists/kPointList/tetraeder/tet': ['vol'],
                 '/fleurInput/calculationSetup/bzIntegration/kPointLists/kPointList/triangles': ['ntria'],
                 '/fleurInput/calculationSetup/bzIntegration/kPointLists/kPointList/triangles/tria': ['vol'],
