...
@register_migration(base_version='0.34', target_version='0.31')
def migrate_034_to_031(definition_dict):
    """
    Migrate definitions for MaX5 bugfix release to MaX4 release
