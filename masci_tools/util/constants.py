...
.. note::
    ...
    1) For KKR constants versions used starting from masci-tools v0.4.7, more specifically starting from
    commit 66953f8, Apr 28, 2021, do not set ``MASCI_TOOLS_USE_OLD_CONSTANTS``.

    2) For KKR constants versions used in masci-tools v0.4.0-dev7 - v0.4.6, more specifically starting from
    commit c171563, Feb 16, 2021, to prior to commit 66953f8, Apr 28, 2021,
    set ``MASCI_TOOLS_USE_OLD_CONSTANTS`` to ``Interim``.

    3) For KKR constants versions used prior to masci-tools v0.4.0-dev7, more specifically prior to
